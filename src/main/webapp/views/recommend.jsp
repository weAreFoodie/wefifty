...
<div class=" flex flex-row  h-screen justify-center items-center overflow-hidden bg-gray-100 relative">
		...
		<div class="swiper-container">
			<div class="swiper-wrapper">
				...
				<div class="swiper-slide">
					<div class="relative w-[100%] h-[80vh] rounded-3xl shadow-xl overflow-hidden">
